...
Doctor _$DoctorFromJson(Map<String, dynamic> json) {
  return Doctor(
    ...
    clinicStartHour: json['clinicStartHour'] as String,
    clinicEndHour: json['clinicEndHour'] as String,
...
Map<String, dynamic> _$DoctorToJson(Doctor instance) => <String, dynamic>{
      ...
      'clinicStartHour': instance.clinicStartHour,
      'clinicEndHour': instance.clinicEndHour,
